...
WebUI.click(findTestObject('Page_CURA Healthcare Service/h2_Login'))

WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/h2_Login'), 'Login')

WebUI.click(findTestObject('Page_CURA Healthcare Service/input_form-control'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_username'), 'John Doe')

WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_form-control_1'), 'ThisIsNotAPassword')
